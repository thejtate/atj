...
<div class="outer-wrapper">
  ...
  <div class="inner-wrapper">
    <section class="section type-top section-top">
      <div class="bg">
        <div class="clip-path-img-top">
          <div class="bg-img" style="background-image: url('theme/images/tmp/laos-section-top-img.jpg');"
        ...
        <svg width="100%" height="100%">
          <g clip-path="url(#clip-path-img-top)">
            <image xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="theme/images/tmp/laos-section-top-img.jpg"
      ...
      <div class="inner">
        <div class="container">
          <header class="titles">
            <h1>
              <img src="theme/images/titles/title-laos.png" alt=""/>
              <span>LAOS</span>
            </h1>
    ...
    <section class="section type-after-top section-region">
      <div class="bg">
        <div class="clip-path-region">
          <div class="bg-img" style="background-image: url('theme/images/tmp/laos-section-img.jpg');"
               data-bottom-top="transform:translate3d(0px, -150px, 0px)"
               data-top-bottom="transform:translate3d(0px, 150px, 0px)"></div>
        </div>
        <svg width="100%" height="100%" >
          <g clip-path="url(#clip-path-region)">
            <image xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="theme/images/tmp/laos-section-img.jpg"
      ...
      <div class="inner">
        <div class="container">
          <div class="desc-region">
            <div class="map"><img src="theme/images/maps/map-laos.png" alt=""/></div>
            <h4>TAKE A MOMENT AND STEP BACK IN TIME
            </h4>
            <div class="text">
              <p>Travel to Laos to experience a stronghold of tradition and one of the best-kept secrets in Asia. Its quiet ambiance, languid pace and striking natural beauty lap at one's spirit like the slow-flowing waters of the Mekong upon the shore. Timeless rural scenes and a calm spirituality comprise the warp and weft of Lao life, a place where the soul is slowly awakened to an ancient tempo, all but forgotten in the modern world.</p>
            </div>
    ...
    <div class="content-wrapper container">
      ...
      <div class="b-photos">
        <div class="block-bg" style="background-image: url('theme/images/tmp/laos-b-photo-bg.jpg');"></div>
        <div class="items">
          <div class="item style-block-photo type-square">
            <div class="bg"><img src="theme/images/tmp/laos-photo-1.jpg" alt=""/></div>
          </div>
          <div class="item style-block-photo type-half">
            <div class="bg"><img src="theme/images/tmp/laos-photo-2.jpg" alt=""/></div>
          </div>
          <div class="item style-block-photo type-square">
            <div class="bg"><img src="theme/images/tmp/laos-photo-3.jpg" alt=""/></div>
          </div>
          <div class="item style-block-photo type-half">
            <div class="bg"><img src="theme/images/tmp/laos-photo-4.jpg" alt=""/></div>
          </div>
        </div>
      </div>
    </div>

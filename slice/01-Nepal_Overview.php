...
<div class="outer-wrapper">
  ...
  <div class="inner-wrapper">
    <section class="section type-top section-top">
      <div class="bg">
        <div class="clip-path-img-top">
          <div class="bg-img" style="background-image: url('theme/images/tmp/nepal-section-top-img.jpg');"
        ...
        <svg width="100%" height="100%">
          <g clip-path="url(#clip-path-img-top)">
            <image xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="theme/images/tmp/nepal-section-top-img.jpg"
      ...
      <div class="inner">
        <div class="container">
          <header class="titles">
            <h1>
              <img src="theme/images/titles/title-nepal.png" alt=""/>
              <span>NEPAL</span>
            </h1>
            <h5>The highest peaks</h5>
          </header>
    ...
    <section class="section type-after-top section-region">
      <div class="bg">
        <div class="clip-path-region">
          <div class="bg-img" style="background-image: url('theme/images/tmp/nepal-section-img.jpg');"
               data-bottom-top="transform:translate3d(0px, -150px, 0px)"
               data-top-bottom="transform:translate3d(0px, 150px, 0px)"></div>
        </div>
        <svg width="100%" height="100%" >
          <g clip-path="url(#clip-path-region)">
            <image xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="theme/images/tmp/nepal-section-img.jpg"
      ...
      <div class="inner">
        <div class="container">
          <div class="desc-region">
            <div class="map"><img src="theme/images/maps/map-nepal.png" alt=""/></div>
            <h4>CULTURAL TREASURES AMIDST
              THE WORLD’S HIGHEST PEAKS
            </h4>
            <div class="text">
              <p>Dot the world's most stunning mountains with traditional Buddhist and Hindu communities, blanket its lowland jungle with profuse and accessible wildlife, sprinkle UNESCO World Heritage cultural sites throughout its ancient towns, and it's easy to understand why the kingdom of Nepal continues to be one of the world's greatest adventure travel destinations.
              </p>
            </div>
    ...
    <div class="content-wrapper container">
      ...
      <div class="b-photos">
        <div class="block-bg" style="background-image: url('theme/images/tmp/nepal-b-photo-bg.jpg');"></div>
        <div class="items">
          <div class="item style-block-photo type-square">
            <div class="bg"><img src="theme/images/tmp/nepal-photo-1.jpg" alt=""/></div>
          </div>
          <div class="item style-block-photo type-half">
            <div class="bg"><img src="theme/images/tmp/nepal-photo-2.jpg" alt=""/></div>
          </div>
          <div class="item style-block-photo type-square">
            <div class="bg"><img src="theme/images/tmp/nepal-photo-3.jpg" alt=""/></div>
          </div>
          <div class="item style-block-photo type-half">
            <div class="bg"><img src="theme/images/tmp/nepal-photo-4.jpg" alt=""/></div>
          </div>
        </div>
      </div>
    </div>

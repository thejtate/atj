<?php $title = '01-Thailand_Overview'; ?>
...
<div class="outer-wrapper">
  ...
  <div class="inner-wrapper">
    <section class="section type-top section-top">
      <div class="bg">
        <div class="clip-path-img-top">
          <div class="bg-img" style="background-image: url('theme/images/tmp/thailand-section-top-img.jpg');"
        ...
        <svg width="100%" height="100%">
          <g clip-path="url(#clip-path-img-top)">
            <image xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="theme/images/tmp/thailand-section-top-img.jpg"
      ...
      <div class="inner">
        <div class="container">
          <header class="titles">
            <h1>
              <img src="theme/images/titles/title-thailand.png" alt=""/>
              <span>THAILAND</span>
            </h1>
            <h5>The land of smiles</h5>
          </header>
    ...
    <section class="section type-after-top section-region">
      <div class="bg">
        <div class="clip-path-region">
          <div class="bg-img" style="background-image: url('theme/images/tmp/thailand-section-img.jpg');"
               data-bottom-top="transform:translate3d(0px, -150px, 0px)"
               data-top-bottom="transform:translate3d(0px, 150px, 0px)"></div>
        </div>
        <svg width="100%" height="100%" >
          <g clip-path="url(#clip-path-region)">
            <image xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="theme/images/tmp/thailand-section-img.jpg"
      ...
      <div class="inner">
        <div class="container">
          <div class="desc-region">
            <div class="map"><img src="theme/images/maps/map-thailand.png" alt=""/></div>
    ...
    <div class="content-wrapper container">
      ...
      <div class="b-photos">
        <div class="block-bg" style="background-image: url('theme/images/tmp/thailand-b-photo-bg.jpg');"></div>
        <div class="items">
          <div class="item style-block-photo type-square">
            <div class="bg"><img src="theme/images/tmp/thailand-photo-1.jpg" alt=""/></div>
          </div>
          <div class="item style-block-photo type-half">
            <div class="bg"><img src="theme/images/tmp/thailand-photo-2.jpg" alt=""/></div>
          </div>
          <div class="item style-block-photo type-square">
            <div class="bg"><img src="theme/images/tmp/thailand-photo-3.jpg" alt=""/></div>
          </div>
          <div class="item style-block-photo type-half">
            <div class="bg"><img src="theme/images/tmp/thailand-photo-4.jpg" alt=""/></div>
          </div>
        </div>
      </div>
    </div>
...
<div class="b-modal modal fade style-video" id="popup-thailand-video" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <video id="thailand-video" class="bg-img" width="100%" controls="controls" preload="metadata">
          <source src="theme/video/ATJ Website Video-HD-Thailand.mp4" type="video/mp4">
          <source src="theme/video/ATJ Website Video-HD-Thailand.webm" type="video/webm">
        </video>
      </div>
    </div>
  </div>

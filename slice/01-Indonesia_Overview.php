<?php $title = '01-Indonesia_Overview'; ?>
...
<div class="outer-wrapper">
  ...
  <div class="inner-wrapper">
    <section class="section type-top section-top">
      <div class="bg">
        <div class="clip-path-img-top">
          <div class="bg-img" style="background-image: url('theme/images/tmp/indonesia-section-top-img.jpg');"
        ...
        <svg width="100%" height="100%">
          <g clip-path="url(#clip-path-img-top)">
            <image xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="theme/images/tmp/indonesia-section-top-img.jpg"
      ...
      <div class="inner">
        <div class="container">
          <header class="titles">
            <h1>
              <img src="theme/images/titles/title-indonesia.png" alt=""/>
              <span>INDONESIA</span>
            </h1>
            <h5>Splendid</h5>
          </header>
          ...
          <a class="btn-play" href="#indonesia-video" data-toggle="modal" data-target="#popup-indonesia-video"></a>
        </div>
      </div>
    </section>
    <section class="section type-after-top section-region">
      <div class="bg">
        <div class="clip-path-region">
          <div class="bg-img" style="background-image: url('theme/images/tmp/indonesia-section-img.jpg');"
               data-bottom-top="transform:translate3d(0px, -150px, 0px)"
               data-top-bottom="transform:translate3d(0px, 150px, 0px)"></div>
        </div>
        <svg width="100%" height="100%" >
          <g clip-path="url(#clip-path-region)">
            <image xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="theme/images/tmp/indonesia-section-img.jpg"
    ...
    <div class="content-wrapper container">
      ...
      <div class="b-photos">
        <div class="block-bg" style="background-image: url('theme/images/tmp/indonesia-b-photo-bg.jpg');"></div>
        <div class="items">
...
<div class="b-modal modal fade style-video" id="popup-indonesia-video" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <video id="indonesia-video" class="bg-img" width="100%" controls="controls" preload="metadata">
          <source src="theme/video/ATJ Website Video-HD-Indonesia.mp4" type="video/mp4">
          <source src="theme/video/ATJ Website Video-HD-Indonesia.webm" type="video/webm">
        </video>
      </div>
    </div>
  </div>

    ...
    <section class="section type-top section-top style-min">
      ...
      <div class="inner">
        <div class="container">
          <header class="titles">
            <h1>
              <img src="theme/images/titles/title-planner.png" alt=""/>
              <span>PLANNER</span>
            </h1>
            <h5>Download your tailored</h5>
          </header>
        </div>
      </div>
    </section>
    <div class="content-wrapper container">
      <div class="form form-type-a">
        <div class="form-caption">
          <div class="img"><img src="theme/images/tmp/tmp-img-1.png" alt=""/></div>
          <div class="caption">
            <h4>Download your tailored planner</h4>

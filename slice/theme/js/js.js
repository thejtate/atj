(function ($) {
  ...
  function initScrollMagic() {
    ...
    var parallaxItems = document.querySelectorAll('.clip-path-img-top, .clip-path-img-top-min, .clip-path-img, .clip-path-region, .clip-path-img-skew, .section-latest, .clip-path-experts, .clip-path-img-top-a');
  ...
  function initSectionWidth() {
    var clipPathImg = document.querySelectorAll('.clip-path-img-top, .clip-path-img-top-min, .clip-path-img, .clip-path-region, .clip-path-img-skew, .clip-path-experts, .clip-path-img-top-a, .clip-path-experts-a');
    var clipPath = document.querySelectorAll('#clip-path-img-top polygon, #clip-path-img-top-min polygon, #clip-path-img polygon, #clip-path-region polygon, #clip-path-img-skew polygon, #clip-path-experts polygon, #clip-path-img-top-a polygon, #clip-path-experts-a polygon');
    ...
    function setPoly() {
      ...
      try {
        ...
        clipPath[6].setAttribute('points', '0 0,0' + (isMobile ? ' 424,' : ' 698,') + windowWHalf + (isMobile ? ' 470,' : ' 843,') + windowW + (isMobile ? ' 424,' : ' 698,') + windowW + ' 0');

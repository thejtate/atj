...
<div class="outer-wrapper">
  ...
  <div class="inner-wrapper">
    <section class="section type-top section-top">
      <div class="bg">
        <div class="clip-path-img-top">
          <div class="bg-img" style="background-image: url('theme/images/tmp/japan-section-top-img.jpg');"
        ...
        <svg width="100%" height="100%">
          <g clip-path="url(#clip-path-img-top)">
            <image xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="theme/images/tmp/japan-section-top-img.jpg"
      ...
      <div class="inner">
        <div class="container">
          <header class="titles">
            <h1>
              <img src="theme/images/titles/title-japan.png" alt=""/>
              <span>JAPAN</span>
            </h1>
            <h5>The best of old and new</h5>
          </header>
          ...
          <a class="btn-play" href="#japan-video" data-toggle="modal" data-target="#popup-japan-video"></a>
        </div>
      </div>
    </section>
    <section class="section type-after-top section-region">
      <div class="bg">
        <div class="clip-path-region">
          <div class="bg-img" style="background-image: url('theme/images/tmp/japan-section-img.jpg');"
               data-bottom-top="transform:translate3d(0px, -150px, 0px)"
               data-top-bottom="transform:translate3d(0px, 150px, 0px)"></div>
        </div>
        <svg width="100%" height="100%" >
          <g clip-path="url(#clip-path-region)">
            <image xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="theme/images/tmp/japan-section-img.jpg"
      ...
      <div class="inner">
        <div class="container">
          <div class="desc-region">
            <div class="map"><img src="theme/images/maps/map-japan.png" alt=""/></div>
            <h4>ANCIENT ARTS THRIVE AMONG INNOVATION</h4>
            <div class="text">
              <p>All cultures are a mix of the indigenous and the assimilated, but Japan is singularly defined by its ability to preserve the ancient while thriving amidst the modern. Thus it is a land where the national sport, Sumo wrestling (dating back to 200 AD as a Shinto rite to produce an abundant harvest), vies for TV time with the post WWII-era baseball craze. Highly ritualized yet simple, elegant yet bold, traditional yet evolving, static yet dynamic, Japan's contradictions are utterly fascinating.</p>
            </div>
    ...
    <div class="content-wrapper container">
      ...
      <h2>
        <img src="theme/images/titles/title-activities.png" alt=""/>
      ...
      <div class="b-photos">
        <div class="block-bg" style="background-image: url('theme/images/tmp/japan-b-photo-bg.jpg');"></div>
        <div class="items">
          <div class="item style-block-photo type-square">
            <div class="bg"><img src="theme/images/tmp/japan-photo-1.jpg" alt=""/></div>
          </div>
          <div class="item style-block-photo type-half">
            <div class="bg"><img src="theme/images/tmp/japan-photo-2.jpg" alt=""/></div>
          </div>
          <div class="item style-block-photo type-square">
            <div class="bg"><img src="theme/images/tmp/japan-photo-3.jpg" alt=""/></div>
          </div>
          <div class="item style-block-photo type-half">
            <div class="bg"><img src="theme/images/tmp/japan-photo-4.jpg" alt=""/></div>
          </div>
        </div>
      </div>
    </div>
...
<div class="b-modal modal fade style-video" id="popup-japan-video" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <video id="japan-video" class="bg-img" width="100%" controls="controls" preload="metadata">
          <source src="theme/video/ATJ Website Video-HD-Japan.mp4" type="video/mp4">
          <source src="theme/video/ATJ Website Video-HD-Japan.webm" type="video/webm">
        </video>
      </div>
    </div>
  </div>

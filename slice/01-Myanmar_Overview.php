...
<div class="outer-wrapper">
  ...
  <div class="inner-wrapper">
    <section class="section type-top section-top">
      <div class="bg">
        <div class="clip-path-img-top">
          <div class="bg-img" style="background-image: url('theme/images/tmp/myanmar-section-top-img.jpg');"
        ...
        <svg width="100%" height="100%">
          <g clip-path="url(#clip-path-img-top)">
            <image xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="theme/images/tmp/myanmar-section-top-img.jpg"
      ...
      <div class="inner">
        <div class="container">
          <header class="titles">
            <h1>
              <img src="theme/images/titles/title-myanmar.png" alt=""/>
              <span>MYANMAR</span>
            </h1>
          ...
          <a class="btn-play" href="#myanmar-video" data-toggle="modal" data-target="#popup-myanmar-video"></a>
        </div>
      </div>
    </section>
    <section class="section type-after-top section-region">
      <div class="bg">
        <div class="clip-path-region">
          <div class="bg-img" style="background-image: url('theme/images/tmp/myanmar-section-img.jpg');"
               data-bottom-top="transform:translate3d(0px, -150px, 0px)"
               data-top-bottom="transform:translate3d(0px, 150px, 0px)"></div>
        </div>
        <svg width="100%" height="100%" >
          <g clip-path="url(#clip-path-region)">
            <image xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="theme/images/tmp/myanmar-section-img.jpg"
      ...
      <div class="inner">
        <div class="container">
          <div class="desc-region">
            <div class="map"><img src="theme/images/maps/map-myanmar.png" alt=""/></div>
            <h4>A CHANCE TO STEP BACK IN TIME
            </h4>
            <div class="text">
              <p>They say there’s no time like the present, but that has never been more apt than now: it’s a golden moment for travel to Myanmar, often referred to as Burma. The country is opening its doors, and a joie de vivre is permeating the land. At the same time,  there is a palpable sense that sweeping change will ensue.</p>
              <p>A trip to Myanmar can now access areas that have been isolated from the outside world for decades</p>
            </div>
    ...
    <div class="content-wrapper container">
      ...
      <div class="b-photos">
        <div class="block-bg" style="background-image: url('theme/images/tmp/myanmar-b-photo-bg.jpg');"></div>
        <div class="items">
          <div class="item style-block-photo type-square">
            <div class="bg"><img src="theme/images/tmp/myanmar-photo-1.jpg" alt=""/></div>
          </div>
          <div class="item style-block-photo type-half">
            <div class="bg"><img src="theme/images/tmp/myanmar-photo-2.jpg" alt=""/></div>
          </div>
          <div class="item style-block-photo type-square">
            <div class="bg"><img src="theme/images/tmp/myanmar-photo-3.jpg" alt=""/></div>
          </div>
          <div class="item style-block-photo type-half">
            <div class="bg"><img src="theme/images/tmp/myanmar-photo-4.jpg" alt=""/></div>
          </div>
        </div>
      </div>
    </div>
...
<div class="b-modal modal fade style-video" id="popup-myanmar-video" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <video id="myanmar-video" class="bg-img" width="100%" controls="controls" preload="metadata">
          <source src="theme/video/ATJ Website Video-HD-Burma.mp4" type="video/mp4">
          <source src="theme/video/ATJ Website Video-HD-Burma.webm" type="video/webm">
        </video>
      </div>
    </div>
  </div>

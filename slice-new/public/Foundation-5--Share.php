...
<div class="inner-wrapper">
  ...
  <section class="section section-lanterns style-a">
    <div class="bg">
      <div class="bg-img" style="background-image: url('theme/images/tmp/section-img-42.jpg');"></div>
    </div>
    <div class="container">
      <div class="inner">
        ...
        <div class="text-message">
          <div class="text-inner">
            This holiday season, I donated to ATJ Foundation <br>
            to help with on-going efforts in Asia. <br>
            Please join me and let’s make a difference!
          </div>
          <div class="btn-wrap">
            <a class="link style-burgundy" href="#">Learn how you can help</a>
          </div>
        </div>
      </div>

<!DOCTYPE html>
<html>
<?php $title = 'Foundation-3-LanternOfWellWishes'; ?>
<?php include 'tpl/includes/head.inc'; ?>
<body class="page page-foundation">
...
<div class="inner-wrapper">
  ...
  <section class="section section-lanterns">
    <div class="bg">
      <div class="bg-img" style="background-image: url('theme/images/tmp/section-img-41.jpg');"></div>
    </div>
    <div class="container">
      <div class="form form-lantern">
        <div class="img">
          <img src="theme/images/tmp/lanterns-bg.png" alt=""/>
        </div>
        <div class="title">
          <span>SEND YOUR</span>
          <span>LANTERN</span>
        ...
        <div class="desc">
          <p>Send a lantern of well wishes from you or on behalf of someone else and it will show up with the other lanterns people have sent on our Foundations page.</p>
        </div>
        <div class="form-item form-type-text">
          <label><span class="form-required">*</span>Well Wisher’s Name</label>
...
<?php include 'tpl/layout/footer.inc'; ?>
  <div id="tooltip-donation-1" class="donation-tooltip">
    <div class="title">
      <div class="name">
        Bob
      </div>
    ...
    <div class="text">
      Well wishes from OK! We’ll be in Myanmar next June to help out however we can.
    </div>
  </div>

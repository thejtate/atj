...
$title_image = isset($title_image) ? $title_image : '';
$body = isset($body) ? $body : '';

$content_wrapper_class = (isset($content_wrapper_class) && is_array($content_wrapper_class)) ?
  implode(' ', $content_wrapper_class) : '';
$content_inner_class = (isset($content_inner_class) && is_array($content_inner_class)) ?
  implode(' ', $content_inner_class) : '';

$destination_generator = isset($destination_generator) ? $destination_generator : '';
?>

<div id="outer-wrapper" class="outer-wrapper">

  <?php if (!empty($atj_header)): ?>
    <?php print $atj_header; ?>
  <?php else: ?>
...
<!--            <li><a href="--><?php //print url('node/151')?><!--">MUST SEE <span class="must-see-count"></span> <span class="ico ss-icon ss-glyphish-outlined ss-pushpin"></span></a></li>-->
  ...
  <div class="inner-wrapper">
    ...
    <?php endif; ?>
      ...
      <?php print render($page_top_section); //See templates in templates/page_top_section/?>

    <?php if (isset($region_section)): ?>
      <?php print $region_section; ?>
    <?php endif; ?>
    <?php if (isset($destination_generator)): ?>
      <?php print $destination_generator; ?>
    <?php endif; ?>
    <?php print !empty($seo_elements) ? $seo_elements : ''; ?>
    ...
    <div class=" <?php print $content_wrapper_class; ?>">
      ...
      <div class="content-inner <?php print $content_inner_class; ?>">
        ...
        <div class="main-content-wrapper <?php print !empty($page['sidebar_right']) ? 'main' : ''; ?>">
  ...
  <?php if (!empty($atj_footer)): ?>
    <?php print $atj_footer; ?>
  <?php else: ?>

 ...
 */
?>
<section class="section section-lanterns style-a">
    <div class="bg">
        <div class="bg">
    ...
    <div id="node-<?php print $node->nid; ?>" class="container <?php print $classes; ?>"<?php print $attributes; ?>>
        <div class="inner">
          ...
          <?php print render($title_suffix); ?>
            ...
            <?php if(!empty($donation)): ?>
                <?php print render($donation);?>
            <?php endif; ?>

          <div class="text-message"<?php print $content_attributes; ?>>
              <div class="title">
            ...
            <?php
              ...
              hide($content['links']);
              hide($content['body']);
              hide($content['field_donation_success_link']);
              print render($content);
            ?>
              <?php if(!empty($content['field_donation_success_link'])): ?>
                  <div class="btn-wrap">
                      <!-- AddToAny BEGIN -->
                      <a class="a2a_dd link style-purple type-read-more-b" href="https://www.addtoany.com/share"><?php print render($content['field_donation_success_link'][0]['#element']['title']);?></a>
                      <script>
                          var a2a_config = a2a_config || {};
                          a2a_config.linkurl = "<?php print $content['field_donation_success_link'][0]['#element']['display_url'];?>";

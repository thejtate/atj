...
header('Content-Type: text/html;charset=EUC-JP');	// Added by msyk 2004/8/13
...
$BookQuery->SetCharacterEncoding('EUC-JP');	// Added by msyk 2004/8/13
		...
		<table cellspacing="0" cellpadding="2" border="0" bgcolor="#CCCCCC">
			...
			<tr>
				<td align="center" colspan="6">
					<a href="index-euc-jp.php?<?php echo $query; ?>">Return to Book List</a>
				</td>
			</tr>
		</table>
<hr>

...
$DatasetQuery->SetDBData("Book_List.fp5", "Detail_View", 2);                    // The '->' indicates that SetDBData is part of
...
<html>
    ...
    <body bgcolor="#FFFFFF">
        <pre>
<?php
print_r($BookData);                                                             // pint_r() is a PHP function used to diplay variables

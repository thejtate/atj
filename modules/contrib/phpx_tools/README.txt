...
To use syntax highlighting on another fields (not only on devel/php page)
you should fill field in the admin panel admin/config/development/phpx_tools
regarding instructions on the page.
